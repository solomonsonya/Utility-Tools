...
public class Hash 
{
	 ...
	 * @return
	 */
	public String hash_file(File fleToHash, String hash_algorithm, int minHashLengthToPad, boolean encodeHash_in_base64)
	{
		try
		{
			if(fleToHash == null)
			...
			driver.sop("Commencing hash generation on " + fleToHash.getCanonicalPath());
